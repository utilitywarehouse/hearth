...
`StepperButton`, `ListAction`, `CardAction`, `ListItem`, and `ExpandableCardTrigger` have the same fix, shipped separately in [#1531](https://github.com/utilitywarehouse/hearth/pull/1531) rather than duplicated here.
