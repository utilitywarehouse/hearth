...
- [Figma MCP](#figma-mcp)
  ...
  - [Combine it with Hearth's AI Toolkit](#combine-it-with-hearth's-ai-toolkit)
...
You can set up the toolkit via our plugin, or if you can manually install the
individual elements of the toolkit related to each package. Please refer to the
the package specific documentation to find out more about the available AI
tools, and how to install and use them.
