...
These are components that focus on creating layouts, providing styling and
can be the base building blocks for other components and patterns. Primitives
are built upon our design tokens, making it easier to apply design decisions
coherently.

## Box

<Canvas of={BoxStories.Workshop} sourceState="none" />
...
<Canvas of={FlexStories.Workshop} sourceState="none" />
...
<Canvas of={GridStories.Workshop} sourceState="none" />
