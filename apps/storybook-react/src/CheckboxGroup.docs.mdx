...
<DocsHeader componentName="CheckboxGroup" stories={Stories} />
...
- [RadioGroup](?path=/docs/components-radiogroup--docs): For single-select
...
This component is based on the `FormFieldGroup` component and supports the following common props:
...
| `onCheckedChange` | `(value: Array<string>) => void` |
