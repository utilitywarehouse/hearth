...
<DocsHeader
  ...
  stories={Stories}
  figmaLink="https://www.figma.com/design/6NKZXZhFSExXrcbBgc6zTR/Hearth-Components-%26-Tokens?node-id=1-154&m=dev"
/>
...
- [Link](?path=/docs/components-link--docs) - For standalone links
