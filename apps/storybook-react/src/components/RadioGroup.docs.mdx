...
- [RadioTile width](#radiotile-width)
...
`RadioTile` components will, by default, stretch to fill the width of the
`RadioGroup`, however you can set the `fitContent` prop to make them only take
up as much width as they need.
