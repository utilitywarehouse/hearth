...
- `Skeleton` is a wrapper component that provides the skeleton loading state, and accessibility features.
...
This component is based on `h2` and supports the following common props:
