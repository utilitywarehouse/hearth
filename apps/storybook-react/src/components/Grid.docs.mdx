...
- <StorybookLink to="layout-container">Container</StorybookLink> - For page content, with default responsive padding & gutters
...
| `alignSelf`       | `Responsive<"start" \| "center" \| "end" \| "stretch">`                                           |
