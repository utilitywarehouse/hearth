...
Grouped, related, `Switch` components should be contained within a `fieldset`
element. You can use the `FormFieldGroup` component for this.

<Canvas of={Stories.SwitchGroup} sourceState="none" />
