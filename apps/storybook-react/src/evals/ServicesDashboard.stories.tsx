...
export const Default: Story = {
  render: () => <ServicesDashboard customerName="Alex" services={allServices} />,
};

export const NoCustomerName: Story = {
  render: () => <ServicesDashboard services={allServices} />,
};

export const SingleService: Story = {
  render: () => <ServicesDashboard customerName="Alex" services={[allServices[0]]} />,
};
