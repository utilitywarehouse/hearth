...
This component is based on the `Flex` component and supports the following common style props:
...
| `colorScheme` | `"white" \| "warmWhite" \| "purple" \| "energyGreen" \| "broadbandBlue" \| "mobileRose" \| "insuranceOrange" \| "cashbackLilac"` |
| `paddingNone` | `boolean`                                                                                                                        |
