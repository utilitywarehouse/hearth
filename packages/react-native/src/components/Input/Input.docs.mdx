...
- In disabled state, aria-disabled and accessibilityState will be passed to indicate that the Input is disabled, while keeping it perceivable to assistive tech rather than hiding it entirely.
