...
| illustration         | `ReactNode`                                                                                        | Themed illustration object (mutually exclusive with icon/image)        | `-`            |
| image                | `ReactNode`                                                                                        | Themed image object (mutually exclusive with icon/illustration)        | `-`            |
