...
| `justify`   | `'flex-start' \| 'flex-end' \| 'center' \| 'space-between' \| 'space-around' \| 'space-evenly'` | `flex-start` | The justify content of the flex container. |
| `align`     | `'flex-start' \| 'flex-end' \| 'center' \| 'stretch' \| 'baseline'`                             | `flex-start` | The align items of the flex container.     |
| `spacing`   | `'none' \| 'xs' \| 'sm' \| 'md' \| 'lg' \| 'xl'`                                                | `md`         | The spacing between the                    |
