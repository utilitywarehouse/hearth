...
- [Examples](#examples)
  - [`CheckboxCard` component](#checkboxcard-component)
...
| `type`               | `'default' \| 'card'`               | `default` | The type of the checkbox.                                                                                            |
...
The `CheckboxCard` component is used to create a card-style checkbox input. It inherits all the properties of React Native's `View` component and the `Checkbox` props above.
...
| `showValidationIcon` | `boolean`                           | `true`    | Whether to show the validation icon.                                   |
| `type`               | `'default' \| 'card'`               | `default` | The type of the checkbox group.                                        |
...
The `CheckboxCard` component is a variant of the `Checkbox` component that displays the radio button as a card.
It is used to present options in a more visually appealing way.

<UsageWrap>
  <Center>
    <CheckboxGroup>
      <CheckboxCard value="option-1" aria-label="Label 1" label="Option 1" />
      <CheckboxCard value="option-2" aria-label="Label 2" label="Option 2" />
    </CheckboxGroup>
  </Center>
</UsageWrap>

```tsx
import { CheckboxCard, CheckboxGroup } from '@utilitywarehouse/native-ui';
