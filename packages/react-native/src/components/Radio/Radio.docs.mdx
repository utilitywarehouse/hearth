...
const MyComponent = () => {
  ...
  return (
    <RadioGroup aria-label="Radio Group" value={value} onValueChange={setValue} nativeID="Radio-group">
...
const MyComponent = () => {
  ...
  return (
    <RadioGroup label="Did this solve your problem?" type="tile" value={value} onValueChange={setValue}>
      <Grid columns={2} spacing="md">
        <Radio label="Yes" value="yes" />
        <Radio label="No" value="no" />
        <Radio label="Partly" value="partly" />
...
const MyComponent = () => {
  const [value, setValue] = React.useState('Option 1');
  return (
    <RadioGroup value={value} onValueChange={setValue} aria-label="Radio Group" nativeID="Radio-group">
      <Radio
        value="visa"
        aria-label="Visa"
        label="Visa"
