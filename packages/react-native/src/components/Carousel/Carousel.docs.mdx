...
import { Carousel, CarouselControls, CarouselItem, CarouselItems } from './';
...
```jsx
import { BodyText } from '@utilitywarehouse/native-ui';
...
```jsx
import { BodyText } from '@utilitywarehouse/native-ui';
import { Box, Carousel, CarouselControls } from '@utilitywarehouse/native-ui/lab';
...
This wraps a carousel in dynamic context context, automatically providing all functionality for `CarouselItems`, `CarouselItem`, and `CarouselControls`.

| Name      | Type         | Default | Description                                                                                              |
| --------- | ------------ | ------- | -------------------------------------------------------------------------------------------------------- |
| children? | ReactElement | -       | Display any content within the carousel context. This may include `CarouselItem` and `CarouselControls`. |
