...
- Pagination controls are built-in by default and can be customized or hidden
...
The `Carousel` component includes built-in pagination controls by default. You can customize their appearance or hide them entirely using props.
