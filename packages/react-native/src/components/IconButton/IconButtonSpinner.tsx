...
type IconButtonSpinnerProps = Omit<SpinnerComponentProps, 'size'>;
type IconButtonSpinnerRef = ComponentRef<typeof Spinner>;

const IconButtonSpinner = forwardRef<IconButtonSpinnerRef, IconButtonSpinnerProps>(
  ({ color = '', ...rest }, ref) => {
