...
import { useToggleButtonCardContext } from './ToggleButtonCard.context';

const ToggleButtonCardIndicator = forwardRef<View, ViewProps>((props, ref) => {
  const { checked, active } = useToggleButtonCardContext();
  styles.useVariants({
    checked,
    active,
  });
...
export default ToggleButtonCardIndicator;
