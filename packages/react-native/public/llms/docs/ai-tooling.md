...
broadest set of features. We have this set up as a Claude plugin for the
organisation which you can enable in your Claude configuration. If you want to
set it up yourself, add an entry to your `mcp.json` file:
