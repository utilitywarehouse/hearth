...
import { Alert, BodyText, Box, Card, Center, Flex, Heading, Icon, ThemedImage } from '../src';
...
<br />
<Box my="400">
  <Alert text="By default all components adapt to the current themed color mode. This guide will help you understand how to work with and easily support dark mode in your apps using Hearth React Native." />
</Box>
<br />
<br />
        ...
        <ScopedTheme name="light">
          <Box backgroundColor="brand" p="400">
            <BodyText color="inverted">
              This branded box and text adapts to light or dark mode!
            </BodyText>
          </Box>
          <Box backgroundColor="secondary" p="400">
            <BodyText color="primary">This box and text adapts to light or dark mode!</BodyText>
            <BodyText color="secondary">This secondary text adapts to light or dark mode!</BodyText>
          </Box>
        </ScopedTheme>
      </Flex>
    </Box>
...
```tsx
<Box backgroundColor="brand" p="400">
  <BodyText color="inverted">This branded box and text adapts to light or dark mode!</BodyText>
</Box>
<Box backgroundColor="secondary" p="400">
  <BodyText color="primary">This box and text adapts to light or dark mode!</BodyText>
  <BodyText color="secondary">This secondary text adapts to light or dark mode!</BodyText>
...
```tsx
import { Icon } from '@utilitywarehouse/hearth-react-native';
import { SearchMediumIcon } from '@utilitywarehouse/hearth-react-native-icons';
