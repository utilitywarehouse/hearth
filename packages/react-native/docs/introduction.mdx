...
The `@utilitywarehouse/hearth-react-native` library uses two packages under the hood for colours and icons, feel free to install them if you need to use them in your project.
