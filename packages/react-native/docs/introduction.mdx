...
```console
npm install react-native-unistyles react-native-nitro-module@0.24.1 react-native-svg react-native-reanimated react-native-gesture-handler
```
...
```console
npm install @utilitywarehouse/hearth-tokens @utilitywarehouse/hearth-hearth-react-native-icons
```
