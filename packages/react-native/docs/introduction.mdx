...
```console
npm install react-native-unistyles react-native-edge-to-edge react-native-nitro-modules@0.26.4 react-native-svg react-native-reanimated react-native-gesture-handler
```
