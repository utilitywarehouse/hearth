...
```console
npm install react-native-unistyles react-native-edge-to-edge react-native-nitro-modules@0.28.0 react-native-svg react-native-reanimated react-native-worklets react-native-gesture-handler
```
