...
- [#1487](https://github.com/utilitywarehouse/hearth/pull/1487) [`e154ad6`](https://github.com/utilitywarehouse/hearth/commit/e154ad63cd52e0985962368db5d3d6c3671d6e9a) Thanks [@robphoenix](https://github.com/robphoenix)! - 🐛 [FIX]: Add missing colour, border radius, line height and space tokens
...
- [#1352](https://github.com/utilitywarehouse/hearth/pull/1352) [`e067ce8`](https://github.com/utilitywarehouse/hearth/commit/e067ce82c3d9226becd663a671ea845b001297c5) Thanks [@robphoenix](https://github.com/robphoenix)! - 💅 [ENHANCEMENT]: Add visible scrollbar to `Modal`

  This change ensures there is a visible scrollbar on `Modal` content when it is
  longer than the available viewport height. This improves usability and
  accessibility.
...
- Updated dependencies [[`2165fd8`](https://github.com/utilitywarehouse/hearth/commit/2165fd820cc879fe169df878944b41e337a06c89)]:
  - @utilitywarehouse/hearth-css-reset@0.1.5
...
- [#1336](https://github.com/utilitywarehouse/hearth/pull/1336) [`7130a94`](https://github.com/utilitywarehouse/hearth/commit/7130a9470b38ec70b553aabb4d3ab46dbba188a1) Thanks [@robphoenix](https://github.com/robphoenix)! - 💔 [BREAKING_CHANGE]: Remove pruned design tokens and the CSS classes that use them

  # Breaking Changes: Removed CSS Classes and Tokens
  ...
  | Class            | Token Used             |
  | ---------------- | ---------------------- |
  | `.h-r-radius-lg` | `--h-border-radius-lg` |

  ### Font Weight

  | Class           | Token Used              |
  | --------------- | ----------------------- |
  | `.h-r-fw-heavy` | `--h-font-weight-heavy` |

  ### Gap

  | Class                  | Token Used       |
  | ---------------------- | ---------------- |
  | `.h-r-gap-1000`        | `--h-space-1000` |
  | `.h-r-row-gap-1000`    | `--h-space-1000` |
  | `.h-r-column-gap-1000` | `--h-space-1000` |

  ### Margin

  | Class          | Token Used       |
  | -------------- | ---------------- |
  | `.h-r-m-1000`  | `--h-space-1000` |
  | `.h-r-mx-1000` | `--h-space-1000` |
  | `.h-r-my-1000` | `--h-space-1000` |
  | `.h-r-mt-1000` | `--h-space-1000` |
  | `.h-r-mr-1000` | `--h-space-1000` |
  | `.h-r-mb-1000` | `--h-space-1000` |
  | `.h-r-ml-1000` | `--h-space-1000` |

  ### Padding

  | Class          | Token Used       |
  | -------------- | ---------------- |
  | `.h-r-p-1000`  | `--h-space-1000` |
  | `.h-r-px-1000` | `--h-space-1000` |
  | `.h-r-py-1000` | `--h-space-1000` |
  | `.h-r-pt-1000` | `--h-space-1000` |
  | `.h-r-pr-1000` | `--h-space-1000` |
  | `.h-r-pb-1000` | `--h-space-1000` |
  | `.h-r-pl-1000` | `--h-space-1000` |

  ### Position

  | Class              | Token Used       |
  | ------------------ | ---------------- |
  | `.h-r-inset-1000`  | `--h-space-1000` |
  | `.h-r-top-1000`    | `--h-space-1000` |
  | `.h-r-right-1000`  | `--h-space-1000` |
  | `.h-r-bottom-1000` | `--h-space-1000` |
  | `.h-r-left-1000`   | `--h-space-1000` |

### Patch Changes

- Updated dependencies [[`79fa79d`](https://github.com/utilitywarehouse/hearth/commit/79fa79d029dbd493ee5149f5013b5b152c6e55de)]:
...
- [#1321](https://github.com/utilitywarehouse/hearth/pull/1321) [`da5a25f`](https://github.com/utilitywarehouse/hearth/commit/da5a25fdc3bafbf38f7db9cd4014e0607ce3a29d) Thanks [@robphoenix](https://github.com/robphoenix)! - 🐛 [FIX]: Undefined variant styles when `Table` is a child of `Card`
...
- [#1304](https://github.com/utilitywarehouse/hearth/pull/1304) [`9e9d150`](https://github.com/utilitywarehouse/hearth/commit/9e9d150a3fdfeef8bd443553121e429b1d515373) Thanks [@robphoenix](https://github.com/robphoenix)! - 🐛 [FIX]: `init-ai` script adds h1 headings to markdown config files
...
- [#1303](https://github.com/utilitywarehouse/hearth/pull/1303) [`2aaa51e`](https://github.com/utilitywarehouse/hearth/commit/2aaa51e4cd77696e62f2b6cf373429e4c31fcb7a) Thanks [@robphoenix](https://github.com/robphoenix)! - 💅 [ENHANCEMENT]: Add `shadowColor` prop to `HighlightBanner` component
