...
If you're building UI from a Figma design, start with Figma's own Figma MCP
Server. When building UI from a UX design, this should be the first step, since
it gives your agent direct access to the design you're implementing. You can
read more information about setting this up in the root AI Toolkit
documentation.
