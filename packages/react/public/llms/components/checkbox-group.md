...
| `name`                | `string`                      | —       | The name given as data when submitted as part of a form, shared by all child `Checkbox` components.                                                                                                                                                                   |
| `required`            | `boolean`                     | —       | Marks the checkbox group as requiring at least one selection.                                                                                                                                                                                                         |
| `disabled`            | `boolean`                     | —       | Disables all `Checkbox` components within the group.                                                                                                                                                                                                                  |
| `defaultValue`        | `string[]`                    | —       | The checked values when the group is initially rendered uncontrolled.                                                                                                                                                                                                 |
| `value`               | `string[]`                    | —       | The controlled checked values of the group. Must be used in conjunction with `onValueChange`.                                                                                                                                                                         |
| `onValueChange`       | `((value: string[]) => void)` | —       | Event handler called when the checked values of the group change.                                                                                                                                                                                                     |
