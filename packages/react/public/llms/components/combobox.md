...
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `triggerOnlyOnType`    | `boolean`                                                                                                                           | —       | When `true`, the dropdown only opens once the user starts typing, and the trigger icon button is removed. When `false`, it also opens on click of the input — use this when there is a predefined list of options to choose from.                                                                                                                                                                                                                                                                                                                                                                         |
| `noOptionsFoundText`   | `string`                                                                                                                            | —       | Text shown as a disabled option when a search returns no matches. Only applies when options are passed via the `items` prop.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
