...
<ArgTypes
  of={SegmentedControl}
  include={'size|value|defaultValue|onValueChange|disabled|pressed|defaultPressed|onPressedChange'}
  exclude={'aria-*'}
/>
...
<ArgTypes
  ...
  include={
    'label|icon|value|defaultValue|onValueChange|disabled|pressed|defaultPressed|onPressedChange'
  }
  exclude={'aria-*'}
/>
