...
import type { CardAccordionItemButtonProps } from './CardAccordionItemButton.props';
import { useCardAccordion } from './CardAccordion.context';
import { useCardAccordionItem } from './CardAccordionItem.context';

const COMPONENT_NAME = 'CardAccordionItemButton';
const componentClassName = withGlobalPrefix(COMPONENT_NAME);

type CardAccordionItemButtonElement = ComponentRef<'button'>;

export const CardAccordionItemButton = forwardRef<
  CardAccordionItemButtonElement,
  CardAccordionItemButtonProps
...
CardAccordionItemButton.displayName = COMPONENT_NAME;
