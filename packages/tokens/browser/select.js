export const select = {
  ...
  colorPlaceholder: 'var(--h-select-color-placeholder)',
  dropdown: {
    ...
    item: {
      active: {
        backgroundColor: 'var(--h-select-dropdown-item-active-background-color)',
      },
      ...
      hover: {
        backgroundColor: 'var(--h-select-dropdown-item-hover-background-color)',
      },
