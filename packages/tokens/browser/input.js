export const input = {
  backgroundColor: 'var(--h-input-background-color)',
  borderColor: 'var(--h-input-border-color)',
  borderColorInvalid: 'var(--h-input-border-color-invalid)',
  borderColorReadOnly: 'var(--h-input-border-color-read-only)',
  borderColorValid: 'var(--h-input-border-color-valid)',
