export const color = {
  "broadbandBlue": "--color-broadband-blue",
  "cashbackLilac": "--color-cashback-lilac",
  "darkPurple": "--color-dark-purple",
  "energyGreen": "--color-energy-green",
  "insuranceOrange": "--color-insurance-orange",
  "blue": {
    "50": "--color-blue-50",
    "100": "--color-blue-100",
    "200": "--color-blue-200",
  ...
  "mobileRose": "--color-mobile-rose",
  "offWhite": "--color-off-white",
  "piggyPink": "--color-piggy-pink",
  "uwPurple": "--color-uw-purple",
  "white": "--color-white"
};
