export const checkbox = {
  ...
  checked: {
    ...
    colorActive: 'var(--checkbox-checked-color-active)',
    colorHover: 'var(--checkbox-checked-color-hover)',
    iconColor: 'var(--checkbox-checked-icon-color)',
  },
  unchecked: {
    backgroundColor: 'var(--checkbox-unchecked-background-color)',
    backgroundColorActive: 'var(--checkbox-unchecked-background-color-active)',
    backgroundColorHover: 'var(--checkbox-unchecked-background-color-hover)',
