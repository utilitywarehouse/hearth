export const progressStepper = {
  bar: {
    ...
    future: {
      backgroundColor: 'var(--h-progress-stepper-bar-future-background-color)',
    },
  ...
  indicator: {
    active: {
      backgroundColorHalo: 'var(--h-progress-stepper-indicator-active-background-color-halo)',
    },
    complete: {
      backgroundColor: 'var(--h-progress-stepper-indicator-complete-background-color)',
      iconColor: 'var(--h-progress-stepper-indicator-complete-icon-color)',
    },
    future: {
      borderColor: 'var(--h-progress-stepper-indicator-future-border-color)',
