export const segmentedControl = {
  backgroundColorActive: 'var(--h-segmented-control-background-color-active)',
  backgroundColorHover: 'var(--h-segmented-control-background-color-hover)',
  borderRadius: 'var(--h-segmented-control-border-radius)',
  foregroundColor: 'var(--h-segmented-control-foreground-color)',
  gap: 'var(--h-segmented-control-gap)',
  group: {
    borderColor: 'var(--h-segmented-control-group-border-color)',
  ...
  selected: {
    backgroundColor: 'var(--h-segmented-control-selected-background-color)',
    foregroundColor: 'var(--h-segmented-control-selected-foreground-color)',
  },
} as const;
