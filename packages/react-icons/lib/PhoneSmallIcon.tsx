...
export const PhoneSmallIcon = forwardRef<SVGSVGElement, IconProps>(({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="none" viewBox="0 0 20 20" aria-hidden={!title} focusable="false" role="img" ref={ref} aria-labelledby={titleId} {...props}>{title ? <title id={titleId}>{title}</title> : null}<path fill={color} d="M15.5 17.188q-2.292 0-4.625-1.063t-4.292-3.02q-1.958-1.96-3.02-4.292Q2.5 6.479 2.5 4.167v-1h4.604l.792 3.541-2.438 2.459q.48.812 1.032 1.541.552.73 1.156 1.334.583.583 1.27 1.114.689.531 1.542 1.052l2.5-2.437 3.542.75v4.667z" /></svg>;
});
